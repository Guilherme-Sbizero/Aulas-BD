...
-- configura o formato das datas para o oracle
ALTER SESSION
...
CREATE TABLE departamentos
    ( 
	  departamento_id    NUMBER(6) not null,
...
CREATE TABLE funcionarios
    ( 
	  funcionario_id     NUMBER(6) not null,
      pre_nome           varchar(20),
      ...
      cargo              varchar(10),
      salario            NUMBER(10,2),
      pc_comiss          NUMBER(10,2),
      gerente_id         NUMBER(6),
      departamento_id    NUMBER(6),
